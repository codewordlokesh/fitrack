...
export default function Login() {
  ...
  return (
    <div className="flex flex-row min-h-screen justify-between bg-white">
      {/* Left Side - Image */}
      <div className="h-screen bg-white pl-20">
        <img src="/images/login_img.png" alt="Login Image" className="w-100 h-screen" />
      </div>
      {/* Right Side - Login Form */}
      <div className="flex flex-col items-start justify-center w-1/2 px-10 space-y-6">
        {/* Logo and Title */}
        ...
        <div className="w-full">
          ...
          <h3 className="text-black font-normal text-sm mb-6">
            Your journey to a healthier life starts here.
          </h3>
          {/* Input Fields */}
          <div className="w-96 p-6 rounded-lg space-y-4">
            <Input
              type="text"
              label="Name"
          ...
          {/* Button and Links */}
          <div className="items-center justify-start w-full mt-4">
            <Button color="success" className="w-96">Create account</Button>
          </div>
          ...
          <div className="flex flex-col items-center justify-center w-full mt-4 space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <button aria-label="Sign in with Facebook" className="p-2 rounded-full bg-blue-600 text-white">
              ...
              <button aria-label="Sign in with Google" className="p-2 rounded-full bg-red-500 text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button aria-label="Sign in with Instagram" className="p-2 rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Button color="success" className="w-96" onClick={() => router.push('/login')}>Sign in</Button>
          </div>
        </div>
      </div>
    </div>
